...
export default function Detail() {
  ...
  function sendWhatsapp() {
    /**
     * O "Linking" consegue acessar certas aplicações do 
     * próprio dispositivo usando "deep link", que é 
     * como se fosse uma URL do browser, só que usada 
     * intrinsicamente nos apps (geralmente os mais populares/grandes), e o conteúdo se passa por 
     * query param, como na web.
     */
